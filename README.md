# YouTube Search Visibility Analyzer

A Streamlit app for analyzing organic YouTube ranking exports by keyword, channel, views, title format and keyword-title relevance.

## What the app does

- Uploads an Excel file with YouTube ranking data
- Detects a `SERPs` sheet automatically when available
- Shows KPI cards for keywords, ranking videos, channels and views
- Shows a professional dashboard with tabs for overview, keyword deep-dives, title intelligence and export
